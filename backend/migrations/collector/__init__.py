"""Versioned, repeatable Collector schema migrations."""
...
from collector_app.db import models as _collector_models  # noqa: F401
...
_VERSION_TABLE = "collector_schema_migrations"
...
async def _initial_schema(connection: AsyncConnection) -> None:
    await connection.run_sync(CollectorBase.metadata.create_all)


MIGRATIONS: Sequence[Migration] = (
    Migration(version=1, name="initial_collector_business_schema", apply=_initial_schema),
)
...
async def migrate(settings: CollectorDatabaseSettings | None = None) -> tuple[int, ...]:
